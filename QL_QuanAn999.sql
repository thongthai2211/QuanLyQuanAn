...
SET DATEFORMAT DMY
INSERT INTO NHANVIEN VALUES(N'THONGTHAI','22/11/2002','NAM','012345678',1)
INSERT INTO NHANVIEN VALUES(N'TUẤN KHANG','21/09/2002','NAM','012345678',0)
CREATE TABLE BANAN
(
	MABA int identity,
	TENB NVARCHAR(50),
...
insert into account values(1,N'Nguyễn Thông Thái','123',1)
insert into account values(2,N'Đô Tuấn Kha','123',0)
go
create proc longin
