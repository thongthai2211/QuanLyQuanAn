...
using ThongThai.Methods;
using ThongThai.Models;
    ...
    public partial class BanAn_Gui : UserControl
    {
        ...
        void load_List_BanAn()
        {
            ...
            foreach (BanAn_Model i in lis)
            {
                ...
                btn.Tag = i;
                string s = "Có Người";
                btn.BackgroundImage = global::ThongThai.Properties.Resources._060207072c1ef440ad0f;
                btn.BackgroundImageLayout = ImageLayout.Zoom;
                btn.BackColor = Color.Gray;
                if (i.Tt == 0)
                {
                    btn.BackgroundImage = global::ThongThai.Properties.Resources.cc2273095810804ed901;
                    btn.BackgroundImageLayout = ImageLayout.Zoom;
